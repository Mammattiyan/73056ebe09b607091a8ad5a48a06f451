...
public class BeaconController {
    ...
    *  @retun null
    */
    public void beaconMacthing(Collection<Beacon> beacons) {
        ...
        getBeaconDeatils(beaconMap,beacons);
    }
    ...
    *  @retun null
    */
    private void getBeaconDeatils(final Map<String, String> beaconMap, final Collection<Beacon> beacons) {
            ...
            public boolean onSuccessResponse(RealmResults results) {
                if (results.size() > 0) {
                    ...
                    for (BeaconModel myModel : list) {
                        beaconMap.put("beacon_id", String.valueOf(myModel.getId()));
                        beaconMap.put("distance", String.valueOf(beacons.iterator().next().getDistance()));
                        Log.d("jibi", String.valueOf(beaconMap));
                    }
                }
                return false;
            }
    ...
    public void beaconMacthingTest(Collection<Beacon> beacons) {
